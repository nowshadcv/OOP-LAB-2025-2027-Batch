...
class Employee extends person {
    ...
    Employee(String name, String gender, String address, int age, String empid, String company_name, String qualification, float salary){
        ...
        this.salary = salary;}}
class TeacherD extends Employee {
    String subject, department, teacherid;
    TeacherD(String name, String gender, String address, int age, String empid, String company_name, String qualification, float salary, String subject, String department, String teacherid){
...
class TeacherArrObjects {
    public static void main(String[] args) {
        ...
        int n = sct.nextInt();
        TeacherD teacher[] = new TeacherD[n];
        ...
        for(int i = 0; i < n; i++) {
            ...
            teacher[i] = new TeacherD(name, gender, address, age, empid, company_name, qualification, salary, subject, department, tid);}
        System.out.println("\nTeacher Details:\n");
        for(TeacherD t : teacher) {
            t.display();
            System.out.println();
        }
        sct.close();
